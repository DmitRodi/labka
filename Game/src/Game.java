...
public class Game extends JFrame {
 ...
 papich = ImageIO.read(Game.class.getResourceAsStream("dva.jpg"));
 nuts = ImageIO.read(Game.class.getResourceAsStream("nam.jpg"));
 end = ImageIO.read(Game.class.getResourceAsStream("xaxaxa.jpg"));
 game_game = new Game();
 ...
 g.drawImage(papich, -50, -400, null);
 g.drawImage(nuts, (int) drop_left, (int) drop_top, null);
 if(drop_top > game_game.getHeight()) g.drawImage(end, -100, -450, null);
 }
